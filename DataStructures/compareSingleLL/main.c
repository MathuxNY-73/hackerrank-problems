 ...
 *
 */
bool compare_lists_rec(SinglyLinkedListNode* head1, SinglyLinkedListNode* head2) {
    if(head1 != NULL)
    {
        if(head2 != NULL)
        {
            return head1->data == head2->data && compare_lists_rec(head1->next, head2->next);
        }
        else
        {
            return false;
...
bool compare_lists(SinglyLinkedListNode* head1, SinglyLinkedListNode* head2) {
    ...
    while(cur1 != NULL)
    {
        if(cur2 == NULL || cur1->data != cur2->data)
        {
            return false;
        }
